...
require_once __DIR__ . '/../sale/ulOrderInfo.php';
require_once __DIR__ . '/../ajax/ajaxForm.php';
    ...
    public function index(): void
    {
        ...
        $this->response->setOutput(
            $this->load->view(
                ...
                $this->loadCommonFooter(array_merge(self::POST_FIELDS, $posts_fields))
            )
        );
    }
