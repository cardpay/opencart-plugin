...
class Unlimit
{
    ...
    public function __construct()
    {
        ...
        if ($i !== 3) {
            throw new UnlimitException("Invalid arguments. Use TERMINAL_CODE, TERMINAL_PASSWORD and PRODUCTION_MODE");
        }
    ...
    public function create_payment(array $payment): array
    {
        ...
        if ($payment['payment_method'] === 'BANKCARD' &&
            ...
            $this->writeLog(__FUNCTION__ . ' - Payment masked: ' . print_r($paymentMasked, true));
        }
