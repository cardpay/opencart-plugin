...
class ULRestClient
{
    ...
    {
        $connect = curl_init();
        curl_setopt($connect, CURLOPT_USERAGENT, "Unlimint PHP SDK v" . UL::VERSION);
    ...
    protected static function prepare_headers(&$request, &$default_content_type, &$headers, &$json_content, &$form_content)
    {
