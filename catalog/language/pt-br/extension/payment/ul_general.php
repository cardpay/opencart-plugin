...
$err_payment = 'Não foi possível processar seu pagamento.';
$err_name = 'Titular do cartão';
$err_data = 'Data de expiração inválida';

//Text
$_['currency_no_support'] = 'A moeda selecionada não é aceita pelo Unlimint';
