...
4. Open Extension Installer > Installer tab and installation of OpenCart plugin can be done by clicking on the Upload button.
   **![](opencart_4/readme_images/opencart_install.png)**
...
2. Navigate to **Extensions** > **Extensions** > **Payments** (payment methods settings).
   **![](opencart_4/readme_images/opencart_basic_settings.png)**
...
1. Open the payment method settings by clicking on **Action** > **Edit**.
   **![](opencart_4/readme_images/opencart_credit_card.png)**
...
1. Open the payment method settings by clicking on **Action** > **Edit**.
   **![](opencart_4/readme_images/opencart_Boleto.png)**
...
1. Open the payment method settings by clicking on **Action** > **Edit**.
   **![](opencart_4/readme_images/opencart_Google_Pay.png)**
...
1. Open the payment method settings by clicking on **Action** > **Edit**.
   **![](opencart_4/readme_images/opencart_MB_Way.png)**
...
1. Open the payment method settings by clicking on **Action** > **Edit**.
   **![](opencart_4/readme_images/opencart_Multibanco.png)**
...
1. Open the payment method settings by clicking on **Action** > **Edit**.
   **![](opencart_4/readme_images/opencart_PayPal.png)**
...
1. Open the payment method settings by clicking on **Action** > **Edit**.
   **![](opencart_4/readme_images/opencart_Pix.png)**
...
1. Open the payment method settings by clicking on **Action** > **Edit**.
   **![](opencart_4/readme_images/opencart_SEPA_Instant.png)**
...
1. Open the payment method settings by clicking on **Action** > **Edit**.
   **![](opencart_4/readme_images/opencart_SPEI.png)**
...
3. Then, click the **Capture** **payment** button.Capture payment button is available only if the payment status is Authorized and the order status is Processing.
   **![](opencart_4/readme_images/opencart_Capture_button.png)**
...
2. Click **Cancel payment button**.
   **![](opencart_4/readme_images/opencart_Cancel_button.png)**
